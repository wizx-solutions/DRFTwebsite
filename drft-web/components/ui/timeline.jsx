...
export const Timeline = ({data}) => {
    ...
    return (
        <div className="w-full bg-customBG dark:bg-neutral-950 font-sans md:px-10" ref={containerRef}>
            <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
                ...
                <div
                    ...
                    <motion.div
                        ...
                        className="absolute inset-x-0 top-0 w-[6px] bg-gradient-to-t from-customOrange via-customBlue to-transparent from-[0%] via-[50%] rounded-full"/>
                </div>
            </div>
        </div>
    );
