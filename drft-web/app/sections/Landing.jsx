      ...
      <div className='relative h-[100vh] w-dvw overflow-hidden'>
        <div className="flex items-center justify-center h-screen absolute top-0 z-0">
          <div className="relative w-screen h-screen">
              ...
              <div className="absolute lg:-top-[200px] -top-[150px] lg:left-60 left-0 w-[1200px] h-[1200px] lg:bg-blueDark bg-blueDark/75 rounded-full lg:blur-[1000px] blur-[400px] transform -translate-x-1/2 -translate-y-1/2 -z-10"></div>
