...
export function RecruitmentProcess() {
    const data = [
        {
            ...
            content: (
                <div>
                    ...
                    requirements. Whether it's a short-term project, a long-term position, or specialized expertise,
                    we
        ...
        },
        {
            ...
            content: (
                <div>
                    We carefully screen every candidate through in-depth interviews, technical assessments, and
                    skill evaluations. Only the best of the best make the cut, ennsuring they bring the right
            ...
            content: (
                <div>
                    ...
                    remote or in a flexible setup, we provide full support to both the client and talent, guiding
                    them through a seamless onboarding experience. Our goal is to ensure that both parties are fully
                    aligned with the company’s culture, vision, and goals, fostering a strong, long-term partnership
                    from day one.
                </div>
            ),
        }, {
    ...
    return (
        (<div className="w-full px-40">
            <div className="text-4xl text-customBlue font-bold text-center mt-16 mb-16">Bridging Recruitment Process Borders, Breaking Barriers</div>
            <Timeline data={data}/>
        </div>)
    );
}
